...
import me.labs.corobox.corobox.common.adapters.OrderFromAdapter;
...
public class OrderFragmentFrom extends BaseFragment implements IOrdersFragmentView {

    private View view;
    @BindView(R.id.recyclerView) RecyclerView recyclerView;
    @BindView(R.id.no_stuff) TextView textView;

    @Inject OrdersFromFragmentPresenter presenter;

    public static OrderFragmentFrom newInstance() {
        Bundle args = new Bundle();
        OrderFragmentFrom fragment = new OrderFragmentFrom();
    ...
    public void showDataFrom(List<OrderModelFrom> ordersFrom) {
        List<OrderModelFrom> list = new ArrayList<>();
        for (OrderModelFrom orderModelTo : ordersFrom) {
